/*
 * SLAVE Module for Mobile & RC Receiver 6CH communication
...
void initI2CProtocol(){
  ...
  Wire.begin(MY_ADDRESS);          //join I2Cbus as slave with identified address
...
void receiveI2CEvent(int howMany){
    ...
    int x = Wire.read();    // receive last data from master and assign it to int x
...
void listenReceiverEvent(){
  ...
  if (ch1 > 0){chStr1 = String(ch1);} 
  //if (ch2 > 0){chStr2 = String(ch2);}
  //if (ch3 > 0){chStr3 = String(ch3);}
  if (ch4 > 0){chStr4 = String(ch4);}
  if (ch5 > 0){chStr5 = String(ch5);}

  //Serial.println("CH 1:" + chStr1 + ",\t CH 2:" + chStr2 + ",\tCH 3:" + chStr3 + ",\tCH 4:" + chStr4 + ",\tCH 5:" + chStr5);
  Serial.println("CH 1:" + chStr1);
